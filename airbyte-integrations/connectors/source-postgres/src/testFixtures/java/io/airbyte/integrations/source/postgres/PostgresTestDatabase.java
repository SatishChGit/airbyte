...
public class PostgresTestDatabase extends
  ...
  static public PostgresTestDatabase in(PostgresBaseImage imageName, String... methods) {
    final var container = new PostgresContainerFactory().shared(imageName.name(), methods);
